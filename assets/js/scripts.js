document.addEventListener("DOMContentLoaded", function () {
    ...
    const savedTheme = localStorage.getItem("model-number-generator-docs-bs-theme");
    ...
    document.querySelectorAll(".lang-option").forEach(function (link) {
        ...
        link.addEventListener("click", function () {
            ...
            localStorage.setItem("model-number-generator-docs-user-manual-lang", manualPath);
        });
    });
});